/**
 * newsletter.js — attacksurfacemanagementsoftware.com
 * Wires all .newsletter-form elements on the page to the Cloudflare Worker.
 * Drop in site root. No dependencies.
 */

(function () {
  const WORKER_URL = 'https://newsletter-attacksurfacemanagementsoftware.whereismy328.workers.dev/subscribe';
  ...
  function wire(form) {
    ...
    // Avoid double-wiring if script runs twice
